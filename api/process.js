...
// ── PROMPTS ──
const PROMPTS = {
  standard:     "Paraphrase the following text. Keep the same meaning but use different words and sentence structures. Output plain text only — no markdown symbols like **, #, -, or >. Return only the paraphrased text, nothing else:",
  fluency:      "Rewrite the following text to make it flow naturally and sound fluent. Output plain text only — no markdown symbols like **, #, -, or >. Return only the rewritten text, nothing else:",
  creative:     "Paraphrase the following text in a creative engaging way. Keep the core meaning. Output plain text only — no markdown symbols like **, #, -, or >. Return only the paraphrased text, nothing else:",
  formal:       "Rewrite the following text in formal professional tone. Output plain text only — no markdown symbols like **, #, -, or >. Return only the rewritten text, nothing else:",
  simple:       "Simplify the following text using simple words and short sentences. Output plain text only — no markdown symbols like **, #, -, or >. Return only the simplified text, nothing else:",
  natural:      "Rewrite the following AI-generated text to sound completely natural and human-written. Use varied sentence lengths, natural transitions, avoid AI patterns. Output plain text only — no markdown symbols like **, #, -, or >. Return only the rewritten text, nothing else:",
  student:      "Rewrite the following AI-generated text to sound like a real university student wrote it. Mix formal and informal, vary sentence structure. Output plain text only — no markdown symbols like **, #, -, or >. Return only the rewritten text, nothing else:",
  professional: "Rewrite the following AI-generated text to sound like an experienced professional wrote it. Use confident clear language. Output plain text only — no markdown symbols like **, #, -, or >. Return only the rewritten text, nothing else:",
  casual:       "Rewrite the following AI-generated text in a casual conversational tone. Use everyday language and contractions. Output plain text only — no markdown symbols like **, #, -, or >. Return only the rewritten text, nothing else:",
