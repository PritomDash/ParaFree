...
const PROMPTS = {
  ...
  cv_template_pick: "Based on the job title and CV content provided, pick the ONE most suitable template from this list: Classic, Modern, Minimal, Executive, Creative, Compact, Timeline, Tech. Respond with ONLY the template name, nothing else.",
