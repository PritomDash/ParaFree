...
// ── PROMPTS ──
const PROMPTS = {
  paraphrase:   `You are paraphrasing a document. Keep the EXACT SAME structure as the input — same number of paragraphs, same order, same heading/bullet/table positions. OUTPUT: Plain text ONLY. Zero markdown. No #, **, *, __, backticks, ---, === ever. PRESERVE: names, dates, numbers, addresses, amounts, proper nouns. PARAPHRASE: sentence structure, word choice, phrasing only.\n\nNow paraphrase the following text, keeping the exact same structure:`,
  standard:     `You are paraphrasing a document. Keep the EXACT SAME structure as the input — same number of paragraphs, same order, same heading/bullet/table positions. OUTPUT: Plain text ONLY. Zero markdown. No #, **, *, __, backticks, ---, === ever. PRESERVE: names, dates, numbers, addresses, amounts, proper nouns. PARAPHRASE: sentence structure, word choice, phrasing only.\n\nNow paraphrase the following text, keeping the exact same structure:`,
