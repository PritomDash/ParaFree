...
6. **Write the report.** Structure it as: page summary, scores, critical fixes, important fixes, nice-to-have, drafted replacements.
...
- **Targeting the same query as another page on the site.** This is cannibalization. Decide which page should rank before optimizing either.

---

## Output format

Default output is a structured markdown audit. Structure:
...
Keep audits under 1500 words. If a page needs more detail, break into appendices.

---

## Source

Adapted from [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills) — MIT License
