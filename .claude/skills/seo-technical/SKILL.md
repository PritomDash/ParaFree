...
- Pagination handled correctly (consistent canonicals matter)
...
- llms.txt present at the root (for AI crawlers and AEO)
...
7. **Write the report.** Structure: scope + methodology, executive summary, 6-layer score, critical issues, important issues, polish, implementation roadmap.
